...
- [ ] All required fields present per [SCHEMA.md](../SCHEMA.md): `id`, `name`, `attack_class`, `target_class`, `severity`, `prompts`, `mappings`, `judge` (with `model` + `rubric_path`)
...
- [ ] `judge.rubric_path` resolves to an existing `rubrics/<file>.md` (or new file added in this PR)
